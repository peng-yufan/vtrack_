...
def run_sampling(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    expr_module = importlib.import_module('lib.train.sample_script')
...
def main():
    ...
    parser.add_argument('--script', type=str, default="mixformer_vit_online", help='Name of the train script.')
    ...
    parser.add_argument('--save_dir', type=str, default=os.path.abspath(os.path.join(os.getcwd(),
                                                                                     "../../output_loaded")),
                        help='the directory to save checkpoints and logs')
    parser.add_argument('--seed', type=int, default=random.randint(1, 9999), help='seed for random numbers')
    ...
    run_sampling(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
