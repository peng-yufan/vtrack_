...
cfg.TEST.UPDATE_INTERVALS.GOT10K_VAL = [20]
...
cfg.TEST.ONLINE_SIZES.GOT10K_VAL = [3]
...
cfg.TEST.RESET_EPOCH= edict()
cfg.TEST.RESET_EPOCH.LASOT = [800]
cfg.TEST.RESET_EPOCH.GOT10K_TEST = [100]
cfg.TEST.RESET_EPOCH.GOT10K_VAL = [10]
cfg.TEST.RESET_EPOCH.TRACKINGNET = [100]
cfg.TEST.RESET_EPOCH.VOT20 = [100]
cfg.TEST.RESET_EPOCH.VOT20LT = [100]
cfg.TEST.RESET_EPOCH.OTB = [100]
cfg.TEST.RESET_EPOCH.UAV = [100]

cfg.TEST.UNLINEAR= edict()
cfg.TEST.UNLINEAR.SIGMOID= edict()
cfg.TEST.UNLINEAR.SIGMOID.USING = True
cfg.TEST.UNLINEAR.SIGMOID.FACTOR = 10

cfg.TEST.SAMPLE_EPOCH= edict()
cfg.TEST.SAMPLE_EPOCH.LONG_MIN = 5
cfg.TEST.SAMPLE_EPOCH.SHORT_MIN = 3
cfg.TEST.SAMPLE_EPOCH.LONG_MAX = 30
cfg.TEST.SAMPLE_EPOCH.SHORT_MAX = 8
