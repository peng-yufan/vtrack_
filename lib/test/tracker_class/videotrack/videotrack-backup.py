...
import cv2
import os
from lib.models.videotrack.VideoTrack_dy import build_videonet
...
class VideoTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        self.inter_short = 5
        # self.inter_long = 10
        self.sample_id_long = [self.inter_long*i for i in range(self.num_search-self.aver_num)]
        self.sample_id_short = [(self.num_search - self.aver_num)*(self.inter_long-self.inter_short)
    ...
    # #
        ...
        self.search_features = [out_dict['search_feature']] * (self.num_search-self.aver_num)*self.inter_long
        self.template_features = [out_dict['template_feature']] * (self.num_search-self.aver_num)*self.inter_long
        self.pred_boxes = [box_cxcywh_to_xyxy(out_dict['pred_boxes'].view(-1, 4))] * (self.num_search-self.aver_num)*self.inter_long
    ...
    def track(self, image, info: dict = None):
        ...
        if pred_score > 0.5:
            ...
            if self.frame_id % int(self.num_search * self.inter_long * 7) == 0:
