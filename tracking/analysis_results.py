...
# trackers.extend(trackerlist(name='videotrack-factor5.55', parameter_name=args.config, dataset_name=args.dataset_name,
#                             run_ids=0, display_name='videotrack-factor5.55'))
trackers.extend(trackerlist(name=args.script, parameter_name=args.config, dataset_name=args.dataset_name,
                            run_ids=0, display_name='Only_3D_Head-MixVit'))
# trackers.extend(trackerlist(name='mixformer_vit_online', parameter_name=args.config, dataset_name=args.dataset_name,
#                             run_ids=0, display_name='MixVit'))
# trackers.extend(trackerlist(name='Video-MixVit', parameter_name=args.config, dataset_name=args.dataset_name,
#                             run_ids=0, display_name='Video-MixVit'))
...
# plot_results(trackers,dataset,args.dataset_name,merge_results=False,plot_types=('success'))
